    ...
    <div className="profile-container">
      ...
      <aside className="profile-sidebar">
        ...
        <nav className="sidebar-nav">
          <button className="nav-item active">👤 Profile Info</button>
          <button onClick={() => router.push('/account/orders')} className="nav-item">📦 My Orders</button>
          <button onClick={() => router.push('/account/addresses')} className="nav-item">📍 Addresses</button>
      ...
      <main className="profile-content">
        ...
        <div className="info-card">
          <div className="card-top">
            ...
            {!editing ? (
              <button className="edit-trigger" onClick={() => setEditing(true)}>Edit Profile</button>
            ) : (
